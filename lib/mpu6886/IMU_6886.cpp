...
boolean IMU_6886::begin(uint8_t deviceAddress, TwoWire &wirePort, uint8_t intPin)
{
...
void IMU_6886::enableDebugging(Stream &debugPort)
{
 ...
 */
uint8_t IMU_6886::getDeviceID() {
    I2Cdev::readByte(_deviceAddress, IMU_6886_WHOAMI, buffer);
    return buffer[0];
}
 ...
 */
bool IMU_6886::testConnection() {
    uint8_t deviceId = getDeviceID();
    return deviceId == 0x19;
}
